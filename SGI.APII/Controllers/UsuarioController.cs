    ...
    public class UsuarioController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetDataById(int usuarioId)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    Success = false,
                    Message = "Ocurrió un error inesperado al buscar el usuario."
                });
            }
        }
        ...
        public async Task<IActionResult> GetCorreo(string correo)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    Success = false,
                    Message = "Ocurrió un error inesperado al buscar el usuario por correo."
                });
            }
        }
        ...
        public async Task<IActionResult> Modify([FromBody] UsuarioUpdateDto dto)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    Success = false,
                    Message = "Ocurrió un error inesperado al modificar el usuario."
                });
            }
        }
        ...
        public async Task<IActionResult> Disable([FromBody] UsuarioRemoveDto dto)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    Success = false,
                    Message = "Ocurrió un error inesperado al deshabilitar el usuario."
                });
            }
        }
    }
